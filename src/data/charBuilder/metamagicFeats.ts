export const metamagicFeats: object[] = [
  ...
  { name: 'Extend Spell', selectable: [{ 'Dark Bargainer': [1] }], characterCreation: true },
  { name: 'Maximize Spell', selectable: [{ 'Dark Bargainer': [1] }], characterCreation: true },
  { name: 'Quicken Spell', selectable: [{ 'Dark Bargainer': [1] }], characterCreation: true }
]
