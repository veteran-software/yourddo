const defensiveFeats: object[] = [
  ...
  { name: 'Iron Will', selectable: [{ 'Dark Bargainer': [1] }], characterCreation: true },
  { name: 'Lightning Reflexes', selectable: [{ 'Dark Bargainer': [1] }], characterCreation: true },
  { name: 'Toughness', selectable: [{ 'Dark Bargainer': [1] }], characterCreation: true }
]
