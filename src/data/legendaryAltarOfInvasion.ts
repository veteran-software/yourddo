...
export const legendaryAltarOfInvasion: CraftingIngredient[] = [
  {
    ...
    quantity: 1,
    craftedIn: 'Legendary Altar of Invasion',
    binding: {
      type: 'Bound',
      to: 'Account',
      from: 'Acquisition'
  ...
  {
    name: 'Legendary Inferior Focus of Earth',
    requirements: [
      {
        name: 'Legendary Small Glowing Arrowhead',
        quantity: 1,
  ...
  },
  {
    ...
    effectsAdded: [
      {
        name: 'Negative and Poison Spell Critical Damage',
        modifier: '20%',
        bonus: 'Enhancement'
      }
    ]
  ...
  },
  {
    ...
    effectsAdded: [
      {
        name: 'Fortitude Save vs Disease +4',
        bonus: 'Insight'
      },
      {
  ...
  },
  {
    ...
    effectsAdded: [
      {
        name: 'Unconsciousness Range +128',
        bonus: 'Enhancement'
      },
      {
        name: 'Positive Healing per 10s + 16',
        bonus: 'Enhancement'
      }
    ]
  }
