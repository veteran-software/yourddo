...
const Home = () => (
  <Container>
    ...
    <p>
      Welcome to YourDDO, the dedicated online resource for Dungeons and Dragons Online players who want fast, reliable,
      and easy to use tools focused on crafting and character optimization. YourDDO was built from the ground up with
      one primary goal in mind: to make DDO crafting easier and more accessible for everyone, from new players just
      starting their first character to veterans fine tuning their end game gear.
    </p>
    <p>
    ...
    <p>
      In addition to crafting tools, YourDDO includes real time server status displays on every page. This allows you to
      check the status of your favorite worlds at a glance without needing to leave the site or search for external
      links. Server availability is an important part of planning your game time, and we want that information to always
    ...
    <p>
      ...
      community. One of the major future additions will be a Monster Manual reference tool, giving players quick access
      to enemy stats, and locations to help with both questing and favor farming.
    </p>
    <p>
      ...
      discuss crafting systems, or build entirely new features, you are invited to participate. You can find the project
      repository on{' '}
    ...
    <p>
      Our goal is to eventually cover all crafting systems available in the game, including older or niche systems that
      other sites may overlook. We know that DDO crafting is complex and often confusing, and we are committed to
