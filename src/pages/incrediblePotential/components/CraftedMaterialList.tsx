    ...
    <>
      ...
      <ListGroup>
        ...
        >
          ...
          <InstructionsPopover
            instructionsText={craftedMaterialInstructions(selectedRing.name)}
          />
        </ListGroup.Item>
        {Object.entries(craftedIngredients)
          .sort(([a], [b]) => a.localeCompare(b))
          .map(([ing, count], idx: number) => {
            const crafted: CraftingIngredient | undefined = Object.values(
              altarOfSubjugation
            ).find((ingredient: CraftingIngredient) => ingredient.name === ing)
            ...
            const farmed: Ingredient | undefined = Object.values(
              ingredients
            ).find((ingredient: Ingredient) => ingredient.name === ing)
