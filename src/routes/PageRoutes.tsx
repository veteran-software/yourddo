...
import NearlyComplete from '../pages/nearlyComplete/NearlyComplete.tsx'
import NearlyFinished from '../pages/nearlyFinished/NearlyFinished.tsx'
  ...
  return (
    <Routes>
      <Route element={<BaseLayout />}>
        ...
        <Route path='/nearly-complete' element={<NearlyComplete />} />
        <Route path='/nearly-finished' element={<NearlyFinished />} />
