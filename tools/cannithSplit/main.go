...
func main() {
    ...
    fmt.Printf("Wrote:\n")
    fmt.Printf("  %s\n", filepath.Join(outputDir, "effects.json"))
    fmt.Printf("  %s\n", filepath.Join(outputDir, "enchantments.json"))
    fmt.Printf("  %s\n", filepath.Join(outputDir, "placements.json"))
    fmt.Printf("  %s\n", filepath.Join(outputDir, "tiers.json"))
    fmt.Printf("  %s\n", filepath.Join(outputDir, "recipes.json"))
    fmt.Printf("  %s\n", filepath.Join(outputDir, "display.json"))
    fmt.Printf("  %s\n", filepath.Join(outputDir, "planner_entries.json"))
    fmt.Printf("  %s\n", filepath.Join(outputDir, "indexes.json"))
}
